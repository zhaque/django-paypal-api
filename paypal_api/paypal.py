...
from paypal_api.response import Response
from paypal_api.conf import *
...
def do_mass_pay(emails_and_amounts, subject = 'Payment Received'):
	...
	i = 0
	for email, amount in emails_and_amounts:
		data['l_email%s' % i] = str(email)
